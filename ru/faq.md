...
description: Список часто задаваемых вопросов и ответов о Портале SCAR по биоразнообразию Антарктики
background: /assets/images/faq_3446790392.jpeg
imageLicense: |
  [*Leptonychotes weddellii* (Lesson, 1826)](/ru/occurrence/search/?entity=3446790392)
---

### Какие данные можно распространять через Портал SCAR по биоразнообразию Антарктики ?

> Мы осуществляем помощь и поддержку в распространении данных, касающихся биоразнообразия Антарктиды, Субантарктических островов и Южного океана через [GBIF](https://www.gbif.org/) и [OBIS](https://www.obis.org/). Сюда входят описания наборов данных, находки организмов, контрольные списки видов, виды, идентифицированные по ДНК, а также данные об учете и отборе. Более подробную информацию см. в [этой статье](https://data-blog.gbif.org/post/data-shareability/).
...
> К добавлению в [информационную сеть SCAR](https://www.gbif.org/ru/network/8534dd20-c368-4a1f-bdaf-e6b390710f89) принимаются любые наборы данных, включающие биологические находки на Антарктиде, Субантарктических островах и в Южном океане. Ограничений по типу первичных данных о биоразнообразии не существует.
...
### Чем Портал SCAR по биоразнообразию Антарктики (biodiversity.aq) отличается от SCAR-MarBIN ?
